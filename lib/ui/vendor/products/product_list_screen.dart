...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  void initState() {
    ...
    if (user?.id != null) {
      Provider.of<ProductProvider>(context, listen: false).loadProducts(user!.id!);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Mes Produits", style: GoogleFonts.poppins(color: Colors.black, fontWeight: FontWeight.bold)),
        centerTitle: true,
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text("Aucun produit", style: GoogleFonts.poppins(color: Colors.grey)),
                ],
              ),
            );
          }
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        backgroundColor: const Color(0xFF1E293B), // Bleu nuit
  ...
  Widget _buildProductCard(ProductModel product) {
    return Container(
      ...
      child: Row(
        children: [
          // Image factice (Placeholder coloré)
          Container(
            width: 70,
            height: 70,
            decoration: BoxDecoration(
            ...
            child: Icon(Icons.fastfood, color: Colors.blue.shade300, size: 30),
          ),
